document.addEventListener("DOMContentLoaded", function () {
  ...
  if (heightHeader) {
    ...
    headerLogoTop.style.background =
      heightHeader.querySelector(".header-bg").style.background;
  }
  //
  ...
  var closeTableOfContentWeek = document.querySelector(
    ".week-table-of-content__title"
  );
  ...
  var showCandidateQuestion = document.querySelectorAll(
  ...
  var popupOutstanding = document.querySelector(
    ".popup-outstanding-project-wrapper"
  );
  ...
  const app = {
    ...
    setImgTopHeader: function () {
      if (getListBannerThumbPc) {
        var getImgAvatarAcitve = getListBannerThumbPc.querySelector(
          ".banner-top-thumb.active"
        );
        var getSrcImgActive = getImgAvatarAcitve.querySelector(
          ".banner-top-thumb__image"
        );
        if (getSrcBannerTopPc) {
          if (getSrcBannerTopPc.getAttribute("src")) {
            getSrcBannerTopPc.setAttribute(
              "src",
              getSrcImgActive.getAttribute("src")
            );
          }
        }
      }
    ...
    handleEvent: function () {
      ...
      if (getListBannerThumbPc) {
        var getChildBannerThumbPc =
          getListBannerThumbPc.querySelectorAll(".banner-top-thumb");
        getChildBannerThumbPc.forEach(function (a) {
          a.onmouseover = function () {
            var getChildBannerThumbPcActive =
              getListBannerThumbPc.querySelector(".banner-top-thumb.active");
            var getSrcChildImgThumb = a.querySelector(
              ".banner-top-thumb__image"
            );
            if (getSrcChildImgThumb) {
              setTimeout(function () {
                getSrcBannerTopPc.setAttribute(
                  "src",
                  getSrcChildImgThumb.getAttribute("src")
                );
              }, 100);
            }
      ...
      if (openSubMenu) {
        openSubMenu.forEach(function (b) {
          ...
          titleSub.onclick = function () {
            var subMenuActive = document.querySelector(
              ".navbar-item-mb.active"
            );
            var iconSubMb2 = document.querySelector(
              ".navbar-item__icon.active"
            );
      ...
      if (footerBlock) {
        if (footerBlock.offsetWidth < 1025) {
          var navbarFooter = footerBlock.querySelectorAll(
            ".footer-right-navbar"
          );
      ...
      if (showCandidateQuestion) {
        showCandidateQuestion.forEach(function (el) {
          el.onclick = function () {
            var elIcon = el.querySelector(
              ".candidate-question-item-header__icon"
            );
      ...
      if (openOutstanding) {
        ...
        // close popup video
        if (popupOutstanding) {
          var closeOutstanding = popupOutstanding.querySelector(
            ".popup-outstanding-close "
          );
      ...
      document.addEventListener("click", function (e) {
        ...
        if (searchHeader) {
          if (
            ...
            !e.target.matches(".navbar--right__img")
          ) {
    ...
    setWidthPointOfView: function () {
      ...
      if (widthPointView) {
        if (widthPointView.offsetWidth < 576) {
          var widthAuthor = widthPointView.querySelector(
            ".point-of-view__left--author"
          );
          if (widthAuthor) {
            $(widthAuthor).slick({
              infinite: false,
      ...
      if (widthOpeningPosition) {
        if (widthOpeningPosition.offsetWidth < 576) {
          var widthWork = widthOpeningPosition.querySelectorAll(
            ".tab-pane-block-opening"
          );
          if (widthWork) {
            $(widthWork).slick({
              infinite: false,
    ...
    pushTopDetail: function () {
      ...
      var detailCenterContent = document.querySelector(
        ".detail-center-wrapper"
      );
      var detailContentWrapper = document.querySelector(
        ...
        if (detailCenterContent) {
          if (heightBannerTopDetail) {
            if (heightBannerTopDetail.offsetWidth > 1024) {
              detailCenterContent.style.marginTop =
                "-1" *
                  (heightBannerTopDetail.offsetHeight -
                    heightNavbar.offsetHeight -
                    296) +
                "px";
            }
            if (
              heightBannerTopDetail.offsetWidth <= 1024 &&
              heightBannerTopDetail.offsetWidth >= 740
            ) {
              detailCenterContent.style.marginTop =
                "-1" *
                  (heightBannerTopDetail.offsetHeight -
            ...
            detailContentWrapper.style.marginTop =
              heightNavbar.offsetHeight + "px";
          }
        }
      }
    },
    ...
    tableOfContents: function () {
      ...
      if (scrollTopDetail && isFixedMb) {
        if (
          scrollTopDetail >=
          isFixedMb.offsetTop - heightHeader.offsetHeight
        ) {
    ...
    fullpageWeek: function () {
      if (weekInPicture) {
        ...
        var menuWeekAnchors = Array.from(
          menuWeek.querySelectorAll(".menu-week-item")
        ).map(function (value) {
        ...
        fpNavActive.forEach(function (a, b) {
          ...
          a.innerHTML = `${b} in ${
            fpNavActive.length - 2
          } stories <ion-icon name="chevron-up-outline" class="count-stories-icon"></ion-icon>`;
        });
